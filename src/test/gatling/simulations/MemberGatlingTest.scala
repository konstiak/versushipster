...
class MemberGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Member entity")
        ...
        .repeat(2) {
            ...
            .post("/api/members")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstName":"SAMPLE_TEXT", "secondName":"SAMPLE_TEXT", "active":null, "voice":null, "photo":"SAMPLE_TEXT", "memberFrom":"2020-01-01T00:00:00.000Z", "memberTo":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
